...
public class OrderManager extends JFrame {
  ...
  txtAdditionalSH, txtAdditionalSHCOL;
  private JLabel lblOrderType, lblOrderAmount;
  private JLabel lblAdditionalTax, lblAdditionalSH, lblAdditionalSHCOl;
  ...
  public OrderManager() {
    ...
    txtAdditionalSHCOL = new JTextField(10);
    ...
    lblAdditionalSHCOl =
    	      new JLabel("Additional S & H(Colombian Only):");
    ...
    buttonPanel.add(lblAdditionalSHCOl);
    buttonPanel.add(txtAdditionalSHCOL);
    ...
    //Aqui agregar el grid del panel
    ...
    gbc.gridx = 0;
    gbc.gridy = 4;
    gridbag.setConstraints(lblAdditionalSHCOl, gbc);
    gbc.anchor = GridBagConstraints.WEST;
    gbc.gridx = 1;
    gbc.gridy = 4;
    gridbag.setConstraints(txtAdditionalSHCOL, gbc);
  ...
  public String getColombianSH() {
	  return txtAdditionalSHCOL.getText();
  }
...
class ButtonHandler implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getActionCommand().equals(OrderManager.CREATE_ORDER)
      ...
      String strColSH = objOrderManager.getColombianSH();
      ...
      dblColSH = new Double(strColSH).doubleValue();
      
      //Create the order
      Order order = createOrder(orderType, dblOrderAmount,
                    dblTax, dblSH, dblColSH);
  ...
  public Order createOrder(String orderType,
      double orderAmount, double tax, double SH, double ColSH) {
    ...
    if (orderType.equalsIgnoreCase(
      ...
      return new ColombianOrder(orderAmount, ColSH);
    }
    return null;
  }
