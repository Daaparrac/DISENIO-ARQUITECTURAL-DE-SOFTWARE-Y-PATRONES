...
public class SearchManager extends JFrame {
  ...
  public static final String LOGICOPERATOR_SRCH = "Logistics Operator SQL Statement";
  ...
  public SearchManager() throws Exception {
    ...
    cmbSearchType.addItem(SearchManager.LOGICOPERATOR_SRCH);
...
class BuilderFactory {
  public UIBuilder getUIBuilder(String str) {
    ...
    } else if (str.equals(SearchManager.LOGICOPERATOR_SRCH)) {
      builder = new LogOpSrchBuilder();
    }
    return builder;
  }
}
